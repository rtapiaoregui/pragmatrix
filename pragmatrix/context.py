...
def contextualizer():
    ...
    paths = {
            ...
            'df_colls_path' : os.path.join(data_path, 'tools', 'df_colls.pkl'), 
            'df_tfidf_path' : os.path.join(data_path, 'tools', 'df_tfidf.pkl'), 
            'df_doc2vec_path' : os.path.join(data_path, 'tools', 'df_doc2vec.pkl'), 
